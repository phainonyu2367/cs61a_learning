...
def is_bst(t):
    ...
    def bst_min(tree):
        ...
        if tree.is_leaf():
            return tree.label
        num = [tree.label] + [bst_min(tree) for tree in tree.branches]
        return min(num)
    
    def bst_max(tree):
        """this function returns the largest value in the tree"""
        if tree.is_leaf():
            return tree.label
        num = [tree.label] + [bst_max(tree) for tree in tree.branches]
        return max(num)
